        ...
        <ul class="space-y-2">
            <li>
                <x-nav-menu-user :href="route('inscricao.show', [Auth::user()->id])" :active="request()->routeIs('inscricao.show', [Auth::user()->id])">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" class="fill-blue-600 m-3 w-6 h-6 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white">
                        <path
